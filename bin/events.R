...
round(cumsum(events[REG == 'NEU', table(dur) / .N]), 2)
round(cumsum(events[REG == 'CEU', table(dur) / .N]), 2)
round(cumsum(events[REG == 'MED', table(dur) / .N]), 2)

round(cumsum(events[REG == 'CEU' & year(start) <= 1900, table(dur) / .N]), 2)
round(cumsum(events[REG == 'CEU' & year(start) > 1900, table(dur) / .N]), 2)
